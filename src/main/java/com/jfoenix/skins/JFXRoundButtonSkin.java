...
public class JFXRoundButtonSkin extends ButtonSkin {
  ...
  public JFXRoundButtonSkin(JFXButton button) {
    super(button);

    buttonRippler = new JFXRippler(new StackPane(), JFXRippler.RipplerMask.CIRCLE, JFXRippler.RipplerPos.FRONT){

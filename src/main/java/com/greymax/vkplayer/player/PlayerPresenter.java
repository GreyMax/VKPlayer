...
public class PlayerPresenter implements Initializable {
    ...
    @FXML
    public ListView<PlaylistBox> playlistItems;
...
//      playlistItems.getItems().add(new Playlist(PlaylistType.ALBUM, album.getTitle()));
        ...
        playlistItems.getSelectionModel()
                .selectedItemProperty()
                .addListener((observable, oldValue, newValue) -> playerModel.setAudioList(newValue.getAudio()));
